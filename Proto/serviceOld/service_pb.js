...
var service_arkit_blend_shapes_pb = require('../service/arkit_blend_shapes_pb.js');
...
proto.service.GetResponseResponse.AudioResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    faceEmotion: (f = msg.getFaceEmotion()) && service_arkit_blend_shapes_pb.ARKitBlendShapesData.toObject(includeInstance, f)
  };
...
proto.service.GetResponseResponse.AudioResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new service_arkit_blend_shapes_pb.ARKitBlendShapesData;
      reader.readMessage(value,service_arkit_blend_shapes_pb.ARKitBlendShapesData.deserializeBinaryFromReader);
...
proto.service.GetResponseResponse.AudioResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      service_arkit_blend_shapes_pb.ARKitBlendShapesData.serializeBinaryToWriter
    );
  }
};
...
proto.service.GetResponseResponse.AudioResponse.prototype.getFaceEmotion = function() {
  return /** @type{?proto.service.ARKitBlendShapesData} */ (
    jspb.Message.getWrapperField(this, service_arkit_blend_shapes_pb.ARKitBlendShapesData, 8));
};
