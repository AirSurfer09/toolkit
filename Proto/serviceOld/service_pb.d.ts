...
import * as service_arkit_blend_shapes_pb from "../service/arkit_blend_shapes_pb";
...
export namespace GetResponseResponse {
  ...
  export class AudioResponse extends jspb.Message {
    ...
    getFaceEmotion(): service_arkit_blend_shapes_pb.ARKitBlendShapesData | undefined;
    setFaceEmotion(value?: service_arkit_blend_shapes_pb.ARKitBlendShapesData): void;
  ...
  export namespace AudioResponse {
    export type AsObject = {
      ...
      faceEmotion?: service_arkit_blend_shapes_pb.ARKitBlendShapesData.AsObject,
    }
